#!/usr/bin/env python3
"""
Few-shot / balanced adaptation:
Fine-tune a GoEmotions-trained RoBERTa checkpoint on CONTARGA (8 labels),
...
DEFAULT_MODEL_PATH = "/home/hpc/v121ca/v121ca21/thesis_models/goemo_roberta_base/checkpoint-1500"
...
def parse_args():
    ...
    ap.add_argument("--out_dir", required=True, help="Where to save the adapted model")
    ap.add_argument("--model_path", default=DEFAULT_MODEL_PATH, help="Base checkpoint path")
...
def main():
    ...
    print("Saved adapted model to:", out_dir)
